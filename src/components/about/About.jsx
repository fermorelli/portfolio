...
import me from '../../assets/fer1.jpg';
                ...
                <div className="about__content">
                    <div className="about__cards">
                        <article className='about__card'>
                            ...
                            <h5>Technologies</h5>
                            <small>HTML, CSS, JavaScript, WordPress + Elementor, React, NodeJS, Express, MongoDB</small>
                        </article>
                        <article className='about__card'>
                            <FaTools className='about_icon'/>
                            <h5>Tools</h5>
                            <small>Google Analytics, Firebase, Postman, Figma, Click Up, Slack, Trello, Photoshop, Illustrator</small>
                        </article>
